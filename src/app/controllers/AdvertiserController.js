...
var AnnouncementController = /** @class */ (function () {
    ...
    AnnouncementController.prototype.get = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, advertisers, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        repository = typeorm_1.getRepository(Advertiser_1.default);
                        return [4 /*yield*/, repository.find()];
                    case 1:
                        advertisers = _a.sent();
                        return [2 /*return*/, res.status(200).json(advertisers)];
                    case 2:
                        error_1 = _a.sent();
                        next(error_1);
                        return [3 /*break*/, 3];
    ...
    AnnouncementController.prototype.store = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, validator, hasNullValues, hasAllValuesInObject, error, advertiser, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        repository = typeorm_1.getRepository(Advertiser_1.default);
                        validator = new Validator_1.default(req.body, 'advertiser');
                        ...
                        return [4 /*yield*/, repository.create(req.body)];
                    case 1:
                        advertiser = _a.sent();
                        return [4 /*yield*/, repository.save(advertiser)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.status(201).json(advertiser)];
                    case 3:
                        error_2 = _a.sent();
                        next(error_2);
                        return [3 /*break*/, 4];
    ...
    AnnouncementController.prototype.update = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, id, validator, hasNullValues, hasAllValuesInObject, error, advertiser, error, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        advertiser = _a.sent();
                        if (!advertiser) {
                            error = new Error('The advertiser doesn\'t exist!');
                            error.status = 400;
                            throw error;
                        }
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.status(200).json(advertiser)];
                    case 3:
                        error_3 = _a.sent();
                        next(error_3);
                        return [3 /*break*/, 4];
    ...
    AnnouncementController.prototype.delete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, id, advertiser, error, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
